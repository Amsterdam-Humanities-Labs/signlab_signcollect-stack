...
$sql_matched_transcriptions = "SELECT DISTINCT m_transcription, m_file FROM matched_transcriptions WHERE (zOg = 'nmm' OR zOg='Nmm') AND added='1'";
...
$sql_nmm_data = "SELECT DISTINCT id, signbank_id FROM nmm_data WHERE (type='ready' OR type='gc')";
