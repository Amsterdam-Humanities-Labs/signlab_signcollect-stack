...
flowchart TB
    ...
    click sb "https://github.com/Amsterdam-Humanities-Labs/signlab_camera-control" "studio_beta"
    ...
    click si "https://github.com/Amsterdam-Humanities-Labs/signlab_studio-archive" "studioIndex"
    click mc "https://github.com/Amsterdam-Humanities-Labs/signlab_mocap" "mocap"
    click drs "https://github.com/Amsterdam-Humanities-Labs/signlab_drs-pipeline" "drs"
    click vf "https://github.com/Amsterdam-Humanities-Labs/signlab_crop-fix-manager" "videoFix"
    click vbf "https://github.com/Amsterdam-Humanities-Labs/signlab_background-fix" "videoBackgroundFix"
    click app "https://github.com/Amsterdam-Humanities-Labs/signlab_mocap-postprocessing" "sC-Animation-PP"
    click zin "https://github.com/Amsterdam-Humanities-Labs/signlab_zinnen-annotation" "zin"
    ...
    click glb "https://github.com/Amsterdam-Humanities-Labs/signlab_body-animation-viewer" "s3b_glb"
    click s3s "https://github.com/Amsterdam-Humanities-Labs/signlab_sam3d-body-queue" "s3b_server"
...
- `hh`: dormant, and outside the path.
- `mhr` and `demo-media`: files, not services.
- `blendAnims`: a tool on top of the baked mocap corpus.
