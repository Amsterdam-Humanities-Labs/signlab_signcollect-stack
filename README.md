...
| [signlab_mocapOverview](https://github.com/Amsterdam-Humanities-Labs/signlab_mocapOverview) | 2 | Studio & mocap | Mocap dataset overview and file-search API (for the avatar team) | PHP + Python | core server | production | [/mocapOverview/](https://signcollect.nl/mocapOverview/) |
